...
describe('template white-label audit', () => {
  ...
  it('keeps the CMS pages preview module status chips on native markup', () => {
    const cmsPagesPreviewSurfaceSource = readRepoFile('../../../src/templates/features/cms/authoring/modules/CmsPagesPreviewSurface.vue')

    expect(cmsPagesPreviewSurfaceSource).toContain("import CmsStatusChip from '../CmsStatusChip.vue'")
    expect(cmsPagesPreviewSurfaceSource).toContain('<CmsStatusChip')
    expect(cmsPagesPreviewSurfaceSource).not.toContain('<q-chip')
  })

  it('keeps the CMS blocks module status chips on native markup', () => {
    const cmsBlocksModuleSource = readRepoFile('../../../src/templates/features/cms/authoring/modules/CmsBlocksModuleSurface.vue')

    expect(cmsBlocksModuleSource).toContain("import CmsStatusChip from '../CmsStatusChip.vue'")
    expect(cmsBlocksModuleSource).toContain('<CmsStatusChip')
  ...
  it('keeps the CMS releases module status chips on native markup', () => {
    const cmsReleasesModuleSource = readRepoFile('../../../src/templates/features/cms/authoring/modules/CmsReleasesModuleSurface.vue')

    expect(cmsReleasesModuleSource).toContain("import CmsStatusChip from '../CmsStatusChip.vue'")
    expect(cmsReleasesModuleSource).toContain('<CmsStatusChip')
    expect(cmsReleasesModuleSource).not.toContain('<q-chip')
  })

  it('keeps the CMS settings module status chips on native markup', () => {
    const cmsSettingsModuleSource = readRepoFile('../../../src/templates/features/cms/authoring/modules/CmsSettingsModuleSurface.vue')

    expect(cmsSettingsModuleSource).toContain("import CmsStatusChip from '../CmsStatusChip.vue'")
    expect(cmsSettingsModuleSource).toContain('<CmsStatusChip')
