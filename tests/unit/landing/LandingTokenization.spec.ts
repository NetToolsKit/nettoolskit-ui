...
describe('Samples runtime consolidation coverage', () => {
  ...
  it('keeps the samples showcase host consuming shared template surfaces from src', () => {
    ...
    expect(templateVisualFamiliesSource).toContain("id: 'approved-reference'")
    expect(templateVisualFamiliesSource).toContain("featuredExampleIds: [sharedComparisonExampleId, 'dashboard-workspace']")
    expect(templateVisualFamiliesSource).toContain("featuredExampleIds: [sharedComparisonExampleId, 'reference-system', 'enterprise']")
    expect(templateVisualFamiliesSource).toContain("featuredExampleIds: [sharedComparisonExampleId, 'auth-login', 'knowledge']")
    expect(templateVisualFamiliesSource).toContain("featuredExampleIds: [sharedComparisonExampleId, 'crud-profile-placeholder', 'cms-authoring']")
    expect(templateVisualFamiliesSource).toContain("featuredExampleIds: [sharedComparisonExampleId, 'editor-workbench']")
