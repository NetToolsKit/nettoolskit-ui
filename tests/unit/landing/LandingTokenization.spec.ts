...
describe('Samples runtime consolidation coverage', () => {
  ...
  it('keeps the samples showcase host consuming shared template surfaces from src', () => {
    ...
    expect(templateVisualFamiliesSource).toContain("exampleId: 'layout-dashboard'")
    expect(templateVisualFamiliesSource).toContain("exampleId: 'dashboard-workspace'")
    expect(templateVisualFamiliesSource).toContain("exampleId: 'reference-system'")
    expect(templateVisualFamiliesSource).toContain("exampleId: 'editor-workbench'")
    expect(templateVisualFamiliesSource).toContain("exampleId: 'crud-profile-placeholder'")
    expect(templateVisualFamiliesSource).toContain("'light',")
    expect(templateVisualFamiliesSource).toContain("'dark',")
