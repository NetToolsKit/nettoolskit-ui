...
export function resolveAppShellTheme(theme: AppShellTheme = {}, baseTheme: AppShellTheme = {}): AppShellTheme {
  ...
  return {
    ...
    cmsLayoutBreakpointLg: pickThemeValue(sourceTheme.cmsLayoutBreakpointLg, '1280'),
    cmsLayoutBreakpointMd: pickThemeValue(sourceTheme.cmsLayoutBreakpointMd, '1024'),
