...
export function resolveAppShellTheme(theme: AppShellTheme = {}, baseTheme: AppShellTheme = {}): AppShellTheme {
  ...
  return {
    ...
    borderWidth: pickThemeValue(sourceTheme.borderWidth, '1px'),
    ...
    groupCaptionMiniRadius: pickThemeValue(sourceTheme.groupCaptionMiniRadius, '999px'),
    ...
    viewportHeight: pickThemeValue(sourceTheme.viewportHeight, '100vh'),
    compactBreakpoint: pickThemeValue(sourceTheme.compactBreakpoint, '500'),
    compactPagePadding: pickThemeValue(sourceTheme.compactPagePadding, 'var(--ntk-shell-space-md)'),
    compactWorkspaceCardPadding: pickThemeValue(sourceTheme.compactWorkspaceCardPadding, 'var(--ntk-shell-space-md)'),
    layoutBreakpointLg: pickThemeValue(sourceTheme.layoutBreakpointLg, sourceTheme.cmsLayoutBreakpointLg, '1280'),
    layoutBreakpointMd: pickThemeValue(sourceTheme.layoutBreakpointMd, sourceTheme.cmsLayoutBreakpointMd, '1024'),
    cmsLayoutBreakpointLg: pickThemeValue(sourceTheme.cmsLayoutBreakpointLg, sourceTheme.layoutBreakpointLg, '1280'),
    cmsLayoutBreakpointMd: pickThemeValue(sourceTheme.cmsLayoutBreakpointMd, sourceTheme.layoutBreakpointMd, '1024'),
    ...
    titleSeparatorSize: pickThemeValue(sourceTheme.titleSeparatorSize, 'calc(var(--ntk-shell-font-size-title-app) + var(--ntk-shell-space-xs))'),
    userAvatarSize: pickThemeValue(sourceTheme.userAvatarSize, 'calc(var(--ntk-shell-search-control-height) - (var(--ntk-shell-space-xs) * 2))'),
    headerBlur: pickThemeValue(sourceTheme.headerBlur, 'blur(calc(var(--ntk-shell-space-sm) * 2))'),
    actionHoverTranslateY: pickThemeValue(sourceTheme.actionHoverTranslateY, 'calc(var(--ntk-shell-space-xs) * -0.5)'),
    itemCaptionOffset: pickThemeValue(sourceTheme.itemCaptionOffset, 'calc(var(--ntk-shell-space-xs) * 0.6)'),
    headerZIndex: pickThemeValue(sourceTheme.headerZIndex, '3000'),
    drawerZIndex: pickThemeValue(sourceTheme.drawerZIndex, '2000'),
    groupSeparatorOpacity: pickThemeValue(sourceTheme.groupSeparatorOpacity, '0.12'),
    badgePulseScale: pickThemeValue(sourceTheme.badgePulseScale, '1.1'),
