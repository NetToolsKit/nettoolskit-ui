...
const defaultLayoutBreakpointLgPx = parseBreakpointToken(
  APP_SHELL_DEFAULT_THEME.layoutBreakpointLg ?? APP_SHELL_DEFAULT_THEME.cmsLayoutBreakpointLg,
  1280
)
...
const layoutBreakpointLgPx = computed(() => {
  return parseBreakpointToken(
    resolvedTheme.value.layoutBreakpointLg ?? resolvedTheme.value.cmsLayoutBreakpointLg,
    defaultLayoutBreakpointLgPx
  )
})
const viewportWidthPx = computed(() => resolveViewportWidth(layoutBreakpointLgPx.value + 1))
...
const shellStyle = computed<Record<string, string>>(() => {
  ...
  return {
    ...
    '--ntk-shell-layout-breakpoint-lg': theme.layoutBreakpointLg ?? theme.cmsLayoutBreakpointLg ?? '',
    '--ntk-shell-layout-breakpoint-md': theme.layoutBreakpointMd ?? theme.cmsLayoutBreakpointMd ?? '',
    '--ntk-shell-cms-layout-breakpoint-lg': theme.cmsLayoutBreakpointLg ?? theme.layoutBreakpointLg ?? '',
    '--ntk-shell-cms-layout-breakpoint-md': theme.cmsLayoutBreakpointMd ?? theme.layoutBreakpointMd ?? '',
 ...
 * No inline style overrides are applied because they would shadow the CSS
 * and prevent shell-level hover tokens from reflecting visually.
 */
