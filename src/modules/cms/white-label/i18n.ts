...
const cmsLocalePacks: Record<CmsLocale, CmsLocalePack> = {
  en: {
    ...
    content: {
      ...
      colorsBannerText: 'Core color fields cascade to related tokens. You can use token values such as var(--ntk-primary) or CSS expressions.',
  ...
  'pt-BR': {
    ...
    userTooltip: 'Conta',
    notificationsTooltip: 'Notificações',
    ...
    items: {
      settings: {
        label: 'Configurações',
        caption: 'White-label',
        description: 'Tokens de tema, branding e configuração por tenant.',
      },
      pages: {
        label: 'Páginas',
        caption: 'Landing pages',
        description: 'Gerencie rotas, status e composição das seções.',
      },
      blocks: {
        label: 'Blocos',
        caption: 'Blocos reutilizáveis',
        description: 'Gerencie blocos reutilizáveis para experiências de landing.',
      },
      media: {
        label: 'Mídia',
        caption: 'Assets',
        description: 'Gerencie imagens e referências de mídia das páginas CMS.',
      },
      releases: {
        label: 'Releases',
        caption: 'Orquestração',
        description: 'Valide, agende, publique e faça rollback de releases.',
      },
    },
    actions: {
      notifications: { label: 'Notificações', tooltip: 'Notificações' },
    ...
    content: {
      ...
      tabTopbarLabel: 'Topbar',
      tabContentLabel: 'Conteúdo',
      moduleFallbackDescription: 'Selecione um módulo no menu lateral.',
      brandingBannerText: 'Alterações de branding são aplicadas imediatamente no shell e favicon.',
      colorsBannerText: 'Campos de cor principais em cascata para tokens relacionados. Você pode usar tokens como var(--ntk-primary) ou expressões CSS.',
      ...
      statusThemeText: 'As cores do tema são totalmente editáveis',
      statusBrandingText: 'Logo e favicon são configuráveis',
      statusMenuText: 'Grupos e itens do menu lateral são configuráveis',
      statusTopbarText: 'Ações da topbar são configuráveis',
      howToTitle: 'Como usar',
      howToBody: 'Abra o módulo de Configurações no menu lateral para editar o white-label. As mudanças são salvas automaticamente no local storage.',
      howToNextStep: 'Próximo passo: vincular essas configurações aos schemas CMS por tenant.',
    },
  },
}
