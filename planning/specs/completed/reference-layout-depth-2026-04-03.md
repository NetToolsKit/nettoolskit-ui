...
Second-pass gap closure against `planning/reference/layout-cms.md`.
4 structural/behavioral gaps remain after the initial 6 were closed (see `planning/completed/reference-layout-gap-closure-2026-04-02.md`).
