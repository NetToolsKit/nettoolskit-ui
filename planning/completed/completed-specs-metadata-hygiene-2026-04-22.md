...
- `rg -n "^Status:\s*(Active|ready-for-planning)" planning/specs/completed` returned no matches.
- `rg -n "planning/specs/active|planning\\specs\\active" planning/completed planning/specs/completed README.md samples/README.md` returned no matches.
