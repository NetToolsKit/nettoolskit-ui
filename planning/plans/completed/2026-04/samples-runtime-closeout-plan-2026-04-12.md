...
6. Completed: archived this plan to `planning/plans/completed/YYYY-MM` after the runtime closed cleanly with no current console issues on the public routes.
