...
- `planning/active/reference-project-patterns-adoption-plan-2026-04-22.md`
- future completed plan path under `planning/completed/`
...
- [ ] Plan is moved to `planning/completed` after implementation evidence is collected.
...
- Move to `planning/completed` only after useful patterns have been converted into tracked implementation slices or completed UI changes.
