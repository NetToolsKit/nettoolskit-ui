...
const messages: LandingMessages = {
  ...
  'pt-BR': {
    ...
    hero: {
      ...
      titleHighlight: 'NetToolsKit',
      description: 'Uma biblioteca completa de componentes com sistema de temas, composables e design tokens para aplicações Vue enterprise.',
      primaryCta: 'Comecar',
    ...
    features: {
      ...
      themeSystemBody: 'Troca de tema em runtime com variáveis CSS. Inclui temas Dark, Light e Monochrome por padrão.',
      ...
      accessibilityBody: 'Componentes aderentes a WCAG com navegação por teclado, ARIA labels e foco controlado.',
      tokensTitle: 'Design Tokens',
      tokensBody: 'Espaçamentos, sombras e transições consistentes definidos em variáveis CSS e mixins SCSS.',
    },
    showcase: {
      title: 'Biblioteca de Componentes',
      subtitle: '22+ componentes prontos para produção organizados por categoria.',
      tabs: {
        form: 'Formulario',
        layout: 'Layout',
        ui: 'UI',
      ...
      items: {
        baseInput: 'Campo de texto com validação',
        baseSelect: 'Seleção simples',
        baseMultiSelect: 'Seleção múltipla com chips',
        baseTextarea: 'Campo de texto multilinha',
        baseDatePicker: 'Seleção de data',
        baseTimePicker: 'Seleção de horário',
        baseHeader: 'Cabeçalho da aplicação',
        baseSidebar: 'Barra lateral de navegação',
        baseFooter: 'Rodapé da aplicação',
        baseHero: 'Seção hero da landing page',
        baseSection: 'Container de seção',
        baseCard: 'Container de conteudo',
        baseButton: 'Botão de ação',
        baseChip: 'Chip de tag/label',
        baseLogo: 'Exibição de logo',
        metricCard: 'Metricas de dashboard',
        infoCard: 'Exibição de informações',
        baseFeatureCard: 'Card de destaque',
        basePricingCard: 'Planos de preco',
        baseCreditCard: 'Exibição de cartão',
        baseSteps: 'Indicador de etapas',
        sectionHeader: 'Título de seção',
        useTheme: 'Gestao de tema',
        useNotification: 'Notificações toast',
        useDialog: 'Gestao de modais',
        useFormRules: 'Regras de validação',
        ...
        useTableColumns: 'Configuração de colunas',
        useBaseField: 'Base de campos de formulario',
        useDialogActions: 'Ações de diálogo',
      },
    },
    developer: {
      ...
      bullet2: 'Definições TypeScript completas',
      bullet3: 'CSS orientado a Quasar com design tokens',
      bullet4: 'Troca de tema em runtime',
      formToolkitTitle: 'Kit completo de formulários',
      formToolkitSubtitle: 'Tudo para criar formulários complexos com validação, acessibilidade e estilo consistente.',
      formFeature1: 'Validação nativa com useFormRules',
      formFeature2: 'Seletores de data e hora com localização',
      formFeature3: 'Seleção múltipla com chips',
      formFeature4: 'Estados e mensagens de erro consistentes',
      composablesTitle: 'Composables poderosos',
      composablesSubtitle: 'Funções de composição Vue 3 reutilizáveis para encapsular lógica e estado.',
      useTheme: 'Troca de tema em runtime',
      useNotification: 'Notificações toast',
      useDialog: 'Diálogos de confirmação',
      useFormRules: 'Regras de validação',
      useDebounce: 'Valores com debounce',
    ...
    themes: {
      title: 'Temas nativos',
      subtitle: 'Três temas prontos para produção com troca em runtime.',
      ...
      lightTitle: 'Light',
      lightBody: 'Tema claro padrão com contraste acessível',
      monochromeTitle: 'Monochrome',
    ...
    footer: {
      brandName: 'NetToolsKit UI Vue',
      description: 'Uma biblioteca Vue 3 + Quasar com sistema de temas, composables e design tokens para aplicações enterprise consistentes.',
      resources: 'Recursos',
      related: 'Relacionados',
      documentation: 'Documentação',
      demoPage: 'Página Demo',
      components: 'Componentes',
      composables: 'Composables',
      copilotInstructions: 'Copilot Instructions',
      ntkCli: 'NTK CLI (Rust)',
