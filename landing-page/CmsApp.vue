      ...
      <div class="cms-shell-page__workspace">
        ...
        <CmsSettingsModuleSurface
          ...
          v-bind="{
            ...
            activeSettingsWorkbenchTabLabel: activeSettingsWorkbenchTab?.label || '',
          ...
          @update:active-settings-tab="(v: string) => { activeSettingsTab = v as CmsSettingsWorkbenchTabId }"
          @update:selected-domain-transfer="(v: string) => { selectedDomainTransfer = v as CmsDomainPayloadDomain }"
          @update:show-advanced-theme-fields="showAdvancedThemeFields = $event"
          @update:selected-authored-content-model-id="(v: string) => { selectedAuthoredContentModelId = v as CmsContentModelId | '' }"
          ...
          @update:selected-authored-content-model-field-preset-id="(v: string) => { selectedAuthoredContentModelFieldPresetId = v as CmsAuthoredContentModelFieldPresetId | '' }"
          ...
          @tenant-import-file-change="(file) => onTenantImportFileChange({ target: { files: [file] } } as unknown as Event)"
          @domain-import-file-change="(file) => onDomainImportFileChange({ target: { files: [file] } } as unknown as Event)"
          @schema-import-file-change="(file) => onSchemaImportFileChange({ target: { files: [file] } } as unknown as Event)"
        />
        ...
        <CmsBlocksModuleSurface
          ...
          @update:selected-palette-block-preset-id="selectedPaletteBlockPresetId = $event"
          ...
          @update:selected-authored-block-preset-id="selectedAuthoredBlockPresetId = $event"
