    ...
    <div class="cms-shell-page" :class="cmsViewportClasses" :style="cmsStyleVars">
      <div class="cms-shell-page__workspace">
        ...
        <CmsSettingsModuleSurface
          ...
          v-bind="cmsSettingsModuleSurfaceProps"
        ...
        <CmsBlocksModuleSurface
          ...
          v-bind="cmsBlocksModuleSurfaceProps"
...
const cmsSettingsModuleSurfaceProps = computed(() => unwrapSurfaceProps({
  settings,
  cmsUiText,
  tr,
...
const cmsBlocksModuleSurfaceProps = computed(() => unwrapSurfaceProps({
